...
2018-11-06 14:46:34,642 [http-nio-8090-exec-2] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:34,662 [http-nio-8090-exec-2] ==> Parameters: de1dd146-bb69-48cb-8203-4c5bf6a5e092(String)
2018-11-06 14:46:34,670 [http-nio-8090-exec-2] <==      Total: 1
2018-11-06 14:46:34,784 [http-nio-8090-exec-3] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:34,785 [http-nio-8090-exec-3] ==> Parameters: de1dd146-bb69-48cb-8203-4c5bf6a5e092(String)
2018-11-06 14:46:34,786 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:46:42,146 [http-nio-8090-exec-4] ==>  Preparing: select * from sys_user t where t.username = ? 
2018-11-06 14:46:42,148 [http-nio-8090-exec-4] ==> Parameters: wuzhihua(String)
2018-11-06 14:46:42,150 [http-nio-8090-exec-4] <==      Total: 1
2018-11-06 14:46:42,159 [http-nio-8090-exec-4] ==>  Preparing: select c.proj from ( select distinct s.proj,s.createTime from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u ,sys_login_service s where s.username=? and p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and s.proj=p.id order by s.createTime desc limit 1 ) c 
2018-11-06 14:46:42,399 [http-nio-8090-exec-4] ==> Parameters: wuzhihua(String)
2018-11-06 14:46:42,400 [http-nio-8090-exec-4] <==      Total: 1
2018-11-06 14:46:42,403 [http-nio-8090-exec-4] ==>  Preparing: select distinct sp.* from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u ,sys_role_permission rp ,sys_permission sp where p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and rp.roleId=r.id and sp.id=rp.permissionId and u.username=? and p.id=? 
2018-11-06 14:46:42,406 [http-nio-8090-exec-4] ==> Parameters: wuzhihua(String), 479(Long)
2018-11-06 14:46:42,412 [http-nio-8090-exec-4] <==      Total: 36
2018-11-06 14:46:42,546 [http-nio-8090-exec-4] ==>  Preparing: insert into t_token(id, val, expireTime, createTime, updateTime) values (?, ?, ?, ?, ?) 
2018-11-06 14:46:42,553 [http-nio-8090-exec-4] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String), {"accountNonExpired":true,"accountNonLocked":true,"authorities":[{"authority":"lte:gcb:list"},{"authority":"lte:config:list"},{"authority":"sys:act:list"},{"authority":"sys:menu:list"},{"authority":"lte:stationcheck:del"},{"authority":"lte:config:del"},{"authority":"sys:role:edit"},{"authority":"lte:loadtest:list"},{"authority":"sys:project:del"},{"authority":"lte:stationcheck:edit"},{"authority":"lte:plan:del"},{"authority":"sys:distribute:edit"},{"authority":"lte:cellcheck:list"},{"authority":"sys:role:list"},{"authority":"sys:lte:manage"},{"authority":"lte:config:edit"},{"authority":"lte:plan:list"},{"authority":"lte:cellcheck:del"},{"authority":"sys:user:del"},{"authority":"sys:role:del"},{"authority":"sys:act:lteconfig"},{"authority":"lte:config:send"},{"authority":"sys:user:list"},{"authority":"lte:gcb:del"},{"authority":"lte:stationcheck:list"},{"authority":"sys:project:edit"},{"authority":"sys:menu:del"},{"authority":"sys:project:list"},{"authority":"sys:distribute:list"},{"authority":"lte:cellcheck:edit"},{"authority":"lte:gcb:edit"},{"authority":"sys:user:edit"},{"authority":"sys:sys:system"},{"authority":"sys:menu:edit"},{"authority":"lte:plan:edit"},{"authority":"sys:diatribute:del"}],"birthday":1538496000000,"createTime":1541240539000,"credentialsNonExpired":true,"email":"19348243@qq.com","enabled":true,"expireTime":1541494002536,"id":10,"loginTime":1541486802536,"nickname":"吴志华","password":"$2a$10$WKXh/sBTxdI2n0dbcyaml.viBOoRo/A4tx6vtLxkyPFq8ZsF4Bgqa","permissions":[{"css":"fa-cog","href":"","id":71,"name":"系统管理","parentId":0,"permission":"sys:sys:system","sort":1,"type":1},{"css":"fa-sitemap","href":"pages/menu/list.html","id":78,"name":"资源管理","parentId":71,"permission":"sys:menu:list","sort":3,"type":1},{"css":"","href":"","id":79,"name":"编辑","parentId":78,"permission":"sys:menu:edit","sort":31,"type":2},{"css":"","href":"","id":80,"name":"删除","parentId":78,"permission":"sys:menu:del","sort":32,"type":2},{"css":"fa-credit-card","href":"pages/project/list.html","id":72,"name":"项目管理","parentId":71,"permission":"sys:project:list","sort":11,"type":1},{"css":"","href":"","id":73,"name":"编辑","parentId":72,"permission":"sys:project:edit","sort":12,"type":2},{"css":"","href":"","id":74,"name":"删除","parentId":72,"permission":"sys:project:del","sort":100,"type":2},{"css":"fa-user-md","href":"pages/role/list.html","id":75,"name":"角色管理","parentId":71,"permission":"sys:role:list","sort":21,"type":1},{"css":"","href":"","id":76,"name":"编辑","parentId":75,"permission":"sys:role:edit","sort":22,"type":2},{"css":"fa-times","href":"","id":77,"name":"删除","parentId":75,"permission":"sys:role:del","sort":23,"type":2},{"css":"fa-user","href":"pages/user/list.html","id":81,"name":"用户管理","parentId":71,"permission":"sys:user:list","sort":24,"type":1},{"css":"","href":"","id":82,"name":"编辑","parentId":81,"permission":"sys:user:edit","sort":100,"type":2},{"css":"","href":"","id":83,"name":"删除","parentId":81,"permission":"sys:user:del","sort":101,"type":2},{"css":"fa-cab","href":"pages/distribute/list.html","id":85,"name":"权限分配","parentId":71,"permission":"sys:distribute:list","sort":200,"type":1},{"css":"","href":"","id":86,"name":"编辑","parentId":85,"permission":"sys:distribute:edit","sort":1,"type":2},{"css":"fa-cab","href":"","id":87,"name":"删除","parentId":85,"permission":"sys:diatribute:del","sort":2,"type":2},{"css":"fa-university","href":"","id":88,"name":"LTE单验","parentId":0,"permission":"sys:lte:manage","sort":2,"type":1},{"css":"fa-send-o","href":"pages/lte/plan/list.html","id":89,"name":"规划表","parentId":88,"permission":"lte:plan:list","sort":3,"type":1},{"css":"","href":"","id":95,"name":"编辑","parentId":89,"permission":"lte:plan:edit","sort":100,"type":2},{"css":"","href":"","id":96,"name":"删除","parentId":89,"permission":"lte:plan:del","sort":100,"type":2},{"css":"fa-bookmark-o","href":"pages/lte/gcbparameter/list.html","id":90,"name":"工参表","parentId":88,"permission":"lte:gcb:list","sort":4,"type":1},{"css":"","href":"","id":97,"name":"编辑","parentId":90,"permission":"lte:gcb:edit","sort":100,"type":2},{"css":"","href":"","id":98,"name":"删除","parentId":90,"permission":"lte:gcb:del","sort":100,"type":2},{"css":"fa-cogs","href":"pages/lte/config/list.html","id":93,"name":"测试配置项","parentId":88,"permission":"lte:config:list","sort":5,"type":1},{"css":"","href":"","id":99,"name":"编辑","parentId":93,"permission":"lte:config:edit","sort":100,"type":2},{"css":"","href":"","id":100,"name":"删除","parentId":93,"permission":"lte:config:del","sort":100,"type":2},{"css":"","href":"","id":106,"name":"流程推送","parentId":93,"permission":"lte:config:send","sort":100,"type":2},{"css":"fa-codepen","href":"pages/lte/stationtest/list.html","id":91,"name":"基站核查结果","parentId":88,"permission":"lte:stationcheck:list","sort":6,"type":1},{"css":"","href":"","id":102,"name":"编辑","parentId":91,"permission":"lte:stationcheck:edit","sort":2,"type":2},{"css":"","href":"","id":101,"name":"删除","parentId":91,"permission":"lte:stationcheck:del","sort":100,"type":2},{"css":"fa-file-archive-o","href":"pages/lte/cellcheck/list.html","id":92,"name":"小区测试结果","parentId":88,"permission":"lte:cellcheck:list","sort":7,"type":1},{"css":"","href":"","id":103,"name":"编辑","parentId":92,"permission":"lte:cellcheck:edit","sort":100,"type":2},{"css":"","href":"","id":104,"name":"删除","parentId":92,"permission":"lte:cellcheck:del","sort":100,"type":2},{"css":"fa-taxi","href":"","id":94,"name":"路测信息","parentId":88,"permission":"lte:loadtest:list","sort":8,"type":1},{"css":"fa-random","href":"","id":105,"name":"流程管理","parentId":0,"permission":"sys:act:list","sort":3,"type":1},{"css":"fa-bar-chart-o","href":"pages/activiti/lteConfigTaskList.html","id":107,"name":"测试配置项任务","parentId":105,"permission":"sys:act:lteconfig","sort":100,"type":1}],"phone":"18301601124","projId":479,"sex":0,"status":1,"telephone":"18301601124","token":"0b141cad-ec79-41c3-bc83-7f2420faf9ac","username":"wuzhihua"}(String), 2018-11-06 16:46:42.536(Timestamp), 2018-11-06 14:46:42.537(Timestamp), 2018-11-06 14:46:42.537(Timestamp)
2018-11-06 14:46:42,564 [http-nio-8090-exec-4] <==    Updates: 1
2018-11-06 14:46:42,715 [http-nio-8090-exec-3] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:42,716 [http-nio-8090-exec-3] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:46:42,719 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:46:42,810 [http-nio-8090-exec-8] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:42,810 [http-nio-8090-exec-8] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:46:42,812 [http-nio-8090-exec-8] <==      Total: 1
2018-11-06 14:46:42,923 [http-nio-8090-exec-4] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:42,924 [http-nio-8090-exec-4] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:46:42,925 [http-nio-8090-exec-4] <==      Total: 1
2018-11-06 14:46:42,931 [http-nio-8090-exec-4] ==>  Preparing: select distinct p.id as "id" ,p.proj_name as "projName" from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u where p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and u.username=? 
2018-11-06 14:46:42,933 [http-nio-8090-exec-4] ==> Parameters: wuzhihua(String)
2018-11-06 14:46:42,934 [http-nio-8090-exec-4] <==      Total: 2
2018-11-06 14:46:42,936 [http-nio-8090-exec-4] ==>  Preparing: select c.proj from ( select distinct s.proj,s.createTime from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u ,sys_login_service s where s.username=? and p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and s.proj=p.id order by s.createTime desc limit 1 ) c 
2018-11-06 14:46:42,936 [http-nio-8090-exec-4] ==> Parameters: wuzhihua(String)
2018-11-06 14:46:42,940 [http-nio-8090-exec-4] <==      Total: 1
2018-11-06 14:46:45,532 [http-nio-8090-exec-6] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:45,532 [http-nio-8090-exec-6] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:46:45,533 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:46:48,365 [http-nio-8090-exec-3] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:48,365 [http-nio-8090-exec-3] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:46:48,366 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:46:48,447 [http-nio-8090-exec-10] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:48,448 [http-nio-8090-exec-10] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:46:48,450 [http-nio-8090-exec-10] <==      Total: 1
2018-11-06 14:46:48,490 [http-nio-8090-exec-10] ==>  Preparing: SELECT count(0) FROM lte_config lp 
2018-11-06 14:46:48,492 [http-nio-8090-exec-10] ==> Parameters: 
2018-11-06 14:46:48,495 [http-nio-8090-exec-10] <==      Total: 1
2018-11-06 14:46:48,497 [http-nio-8090-exec-10] ==>  Preparing: select lp.* from lte_config lp order by lp.createTime desc LIMIT ? 
2018-11-06 14:46:48,499 [http-nio-8090-exec-10] ==> Parameters: 10(Integer)
2018-11-06 14:46:48,502 [http-nio-8090-exec-10] <==      Total: 1
2018-11-06 14:46:55,293 [http-nio-8090-exec-2] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:46:55,294 [http-nio-8090-exec-2] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:46:55,296 [http-nio-8090-exec-2] <==      Total: 1
2018-11-06 14:46:55,302 [http-nio-8090-exec-2] ==>  Preparing: select act_piid from business_activiti_relation where buss_id=? and buss_type=? 
2018-11-06 14:46:55,303 [http-nio-8090-exec-2] ==> Parameters: 4(Long), LteConfig(String)
2018-11-06 14:52:37,842 [http-nio-8090-exec-1] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:52:37,849 [http-nio-8090-exec-1] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:52:37,857 [http-nio-8090-exec-1] <==      Total: 1
2018-11-06 14:52:37,987 [http-nio-8090-exec-3] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:52:37,988 [http-nio-8090-exec-3] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:52:37,989 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:52:38,160 [http-nio-8090-exec-1] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:52:38,160 [http-nio-8090-exec-1] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:52:38,161 [http-nio-8090-exec-1] <==      Total: 1
2018-11-06 14:52:38,168 [http-nio-8090-exec-1] ==>  Preparing: select distinct p.id as "id" ,p.proj_name as "projName" from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u where p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and u.username=? 
2018-11-06 14:52:38,171 [http-nio-8090-exec-1] ==> Parameters: wuzhihua(String)
2018-11-06 14:52:38,173 [http-nio-8090-exec-1] <==      Total: 2
2018-11-06 14:52:38,174 [http-nio-8090-exec-1] ==>  Preparing: select c.proj from ( select distinct s.proj,s.createTime from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u ,sys_login_service s where s.username=? and p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and s.proj=p.id order by s.createTime desc limit 1 ) c 
2018-11-06 14:52:38,178 [http-nio-8090-exec-1] ==> Parameters: wuzhihua(String)
2018-11-06 14:52:38,179 [http-nio-8090-exec-1] <==      Total: 1
2018-11-06 14:52:48,238 [http-nio-8090-exec-9] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:52:48,238 [http-nio-8090-exec-9] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:52:48,239 [http-nio-8090-exec-9] <==      Total: 1
2018-11-06 14:52:48,334 [http-nio-8090-exec-5] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:52:48,335 [http-nio-8090-exec-5] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:52:48,336 [http-nio-8090-exec-5] <==      Total: 1
2018-11-06 14:52:48,404 [http-nio-8090-exec-5] ==>  Preparing: SELECT count(0) FROM lte_config lp 
2018-11-06 14:52:48,405 [http-nio-8090-exec-5] ==> Parameters: 
2018-11-06 14:52:48,406 [http-nio-8090-exec-5] <==      Total: 1
2018-11-06 14:52:48,408 [http-nio-8090-exec-5] ==>  Preparing: select lp.* from lte_config lp order by lp.createTime desc LIMIT ? 
2018-11-06 14:52:48,409 [http-nio-8090-exec-5] ==> Parameters: 10(Integer)
2018-11-06 14:52:48,413 [http-nio-8090-exec-5] <==      Total: 1
2018-11-06 14:52:51,229 [http-nio-8090-exec-3] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:52:51,230 [http-nio-8090-exec-3] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:52:51,231 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:53:17,679 [http-nio-8090-exec-3] ==>  Preparing: select act_piid from business_activiti_relation where buss_id=? and buss_type=? 
2018-11-06 14:53:17,712 [http-nio-8090-exec-3] ==> Parameters: 4(Long), LteConfig(String)
2018-11-06 14:56:36,219 [http-nio-8090-exec-10] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:56:36,227 [http-nio-8090-exec-10] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:56:36,234 [http-nio-8090-exec-10] <==      Total: 1
2018-11-06 14:56:36,339 [http-nio-8090-exec-1] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:56:36,340 [http-nio-8090-exec-1] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:56:36,341 [http-nio-8090-exec-1] <==      Total: 1
2018-11-06 14:56:36,411 [http-nio-8090-exec-9] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:56:36,411 [http-nio-8090-exec-9] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:56:36,413 [http-nio-8090-exec-9] <==      Total: 1
2018-11-06 14:56:36,422 [http-nio-8090-exec-9] ==>  Preparing: select distinct p.id as "id" ,p.proj_name as "projName" from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u where p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and u.username=? 
2018-11-06 14:56:36,424 [http-nio-8090-exec-9] ==> Parameters: wuzhihua(String)
2018-11-06 14:56:36,426 [http-nio-8090-exec-9] <==      Total: 2
2018-11-06 14:56:36,427 [http-nio-8090-exec-9] ==>  Preparing: select c.proj from ( select distinct s.proj,s.createTime from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u ,sys_login_service s where s.username=? and p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and s.proj=p.id order by s.createTime desc limit 1 ) c 
2018-11-06 14:56:36,431 [http-nio-8090-exec-9] ==> Parameters: wuzhihua(String)
2018-11-06 14:56:36,432 [http-nio-8090-exec-9] <==      Total: 1
2018-11-06 14:56:43,974 [http-nio-8090-exec-6] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:56:43,975 [http-nio-8090-exec-6] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:56:43,976 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:56:44,113 [http-nio-8090-exec-6] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:56:44,115 [http-nio-8090-exec-6] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:56:44,117 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:56:44,178 [http-nio-8090-exec-6] ==>  Preparing: SELECT count(0) FROM lte_config lp 
2018-11-06 14:56:44,179 [http-nio-8090-exec-6] ==> Parameters: 
2018-11-06 14:56:44,184 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:56:44,186 [http-nio-8090-exec-6] ==>  Preparing: select lp.* from lte_config lp order by lp.createTime desc LIMIT ? 
2018-11-06 14:56:44,187 [http-nio-8090-exec-6] ==> Parameters: 10(Integer)
2018-11-06 14:56:44,189 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:56:50,072 [http-nio-8090-exec-9] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:56:50,073 [http-nio-8090-exec-9] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:56:50,074 [http-nio-8090-exec-9] <==      Total: 1
2018-11-06 14:56:50,090 [http-nio-8090-exec-9] ==>  Preparing: select distinct act_piid from business_activiti_relation where buss_id=? and buss_type=? 
2018-11-06 14:56:50,094 [http-nio-8090-exec-9] ==> Parameters: 4(Long), LteConfig(String)
2018-11-06 14:57:13,783 [http-nio-8090-exec-6] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:57:13,784 [http-nio-8090-exec-6] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:57:13,786 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:57:13,804 [http-nio-8090-exec-5] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:57:13,805 [http-nio-8090-exec-5] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:57:13,806 [http-nio-8090-exec-5] <==      Total: 1
2018-11-06 14:57:13,960 [http-nio-8090-exec-6] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:57:13,961 [http-nio-8090-exec-6] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:57:13,962 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:57:13,964 [http-nio-8090-exec-6] ==>  Preparing: select distinct p.id as "id" ,p.proj_name as "projName" from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u where p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and u.username=? 
2018-11-06 14:57:13,965 [http-nio-8090-exec-6] ==> Parameters: wuzhihua(String)
2018-11-06 14:57:13,966 [http-nio-8090-exec-6] <==      Total: 2
2018-11-06 14:57:13,967 [http-nio-8090-exec-6] ==>  Preparing: select c.proj from ( select distinct s.proj,s.createTime from sys_project p ,proj_role_relation pr ,sys_role r ,sys_role_user ru ,sys_user u ,sys_login_service s where s.username=? and p.id=pr.proj_id and pr.role_id=r.id and r.id=ru.roleId and u.id=ru.userId and s.proj=p.id order by s.createTime desc limit 1 ) c 
2018-11-06 14:57:13,969 [http-nio-8090-exec-6] ==> Parameters: wuzhihua(String)
2018-11-06 14:57:13,970 [http-nio-8090-exec-6] <==      Total: 1
2018-11-06 14:57:39,434 [http-nio-8090-exec-2] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:57:39,434 [http-nio-8090-exec-2] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:57:39,436 [http-nio-8090-exec-2] <==      Total: 1
2018-11-06 14:57:39,571 [http-nio-8090-exec-3] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:57:39,572 [http-nio-8090-exec-3] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:57:39,573 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:57:39,579 [http-nio-8090-exec-3] ==>  Preparing: SELECT count(0) FROM lte_config lp 
2018-11-06 14:57:39,580 [http-nio-8090-exec-3] ==> Parameters: 
2018-11-06 14:57:39,581 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:57:39,583 [http-nio-8090-exec-3] ==>  Preparing: select lp.* from lte_config lp order by lp.createTime desc LIMIT ? 
2018-11-06 14:57:39,584 [http-nio-8090-exec-3] ==> Parameters: 10(Integer)
2018-11-06 14:57:39,585 [http-nio-8090-exec-3] <==      Total: 1
2018-11-06 14:57:44,625 [http-nio-8090-exec-10] ==>  Preparing: select * from t_token t where t.id = ? 
2018-11-06 14:57:44,625 [http-nio-8090-exec-10] ==> Parameters: 0b141cad-ec79-41c3-bc83-7f2420faf9ac(String)
2018-11-06 14:57:44,627 [http-nio-8090-exec-10] <==      Total: 1
2018-11-06 14:57:44,631 [http-nio-8090-exec-10] ==>  Preparing: select distinct act_piid from business_activiti_relation where buss_id=? and buss_type=? 
2018-11-06 14:57:44,631 [http-nio-8090-exec-10] ==> Parameters: 4(Long), LteConfig(String)
