 ...
 */
public class LteFddPlanInfo implements Serializable {
	...
	public void setLteFddCellChecks(List<LteFddCellCheck> lteFddCellChecks) {
		this.lteFddCellChecks = lteFddCellChecks;
	}

	public List<LteFddParameter> getLteFddParameters() {
		return lteFddParameters;
	}

	public void setLteFddParameters(List<LteFddParameter> lteFddParameters) {
		this.lteFddParameters = lteFddParameters;
	}

	public List<LteFddStation> getLteFddStations() {
		return lteFddStations;
	}

	public void setLteFddStations(List<LteFddStation> lteFddStations) {
		this.lteFddStations = lteFddStations;
	}
	...
	public LteFddPlanInfo(String id, String mENodeBID, String mBaseStationName, String mBaseStationType,
			String mAltitude, String mLongitude, String mLatitude, String mTac, String testPerson,
			String testPersonPhone, String backPerson, String backPersonPhone, String testTime, String dealPersonId,
			Integer status, Integer projId, Date createTime, Date updateTime, Integer createAt, String districtCountry,
