...
public class LteTddParameter implements Serializable {
	...
	public String getMiddleRsrp() {
		return middleRsrp;
	}

	public void setMiddleRsrp(String middleRsrp) {
		this.middleRsrp = middleRsrp;
	}

	public String getMiddleSinr() {
		return middleSinr;
	}

	public void setMiddleSinr(String middleSinr) {
		this.middleSinr = middleSinr;
	}

	public String getMiddleCallSuccPercent() {
		return middleCallSuccPercent;
	}

	public void setMiddleCallSuccPercent(String middleCallSuccPercent) {
		this.middleCallSuccPercent = middleCallSuccPercent;
	}
	...
	public String getHighRsrp() {
		return highRsrp;
	}

	public void setHighRsrp(String highRsrp) {
		this.highRsrp = highRsrp;
	}

	public String getHighSinr() {
		return highSinr;
	}

	public void setHighSinr(String highSinr) {
		this.highSinr = highSinr;
	}

	public String getHighCallSuccPercent() {
		return highCallSuccPercent;
	}

	public void setHighCallSuccPercent(String highCallSuccPercent) {
		this.highCallSuccPercent = highCallSuccPercent;
	}
	...
	public String getBaseRsrp() {
		return baseRsrp;
	}

	public void setBaseRsrp(String baseRsrp) {
		this.baseRsrp = baseRsrp;
	}

	public String getBaseSinr() {
		return baseSinr;
	}

	public void setBaseSinr(String baseSinr) {
		this.baseSinr = baseSinr;
	}

	public String getBaseCallSuccPercent() {
		return baseCallSuccPercent;
	}

	public void setBaseCallSuccPercent(String baseCallSuccPercent) {
		this.baseCallSuccPercent = baseCallSuccPercent;
	}
	...
	public String getElevatorRsrp() {
		return elevatorRsrp;
	}

	public void setElevatorRsrp(String elevatorRsrp) {
		this.elevatorRsrp = elevatorRsrp;
	}

	public String getElevatorSinr() {
		return elevatorSinr;
	}

	public void setElevatorSinr(String elevatorSinr) {
		this.elevatorSinr = elevatorSinr;
	}

	public String getElevatorCallSuccPercent() {
		return elevatorCallSuccPercent;
	}

	public void setElevatorCallSuccPercent(String elevatorCallSuccPercent) {
		this.elevatorCallSuccPercent = elevatorCallSuccPercent;
	}
	...
	public LteTddParameter(String id, String enodeBID, String baseStationName, String cellId, String cellName,
			...
			String middleNum, String middleRsrp, String middleSinr, String middleCallSuccPercent, String highNum,
			String highRsrp, String highSinr, String highCallSuccPercent, String baseNum, String baseRsrp,
			String baseSinr, String baseCallSuccPercent, String elevatorNum, String elevatorRsrp, String elevatorSinr,
			String elevatorCallSuccPercent, String volteSwitch, String rsrpImage, String sinrImage,
			String downRateImage, String upRateImage, String flowCoverRsrpImage, String flowCoverSinrImage,
			String flowCoverpCIImage, String testFlowImage) {
		super();
		this.id = id;
		this.enodeBID = enodeBID;
		this.baseStationName = baseStationName;
