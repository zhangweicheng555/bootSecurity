...
import com.boot.kaizen._enum.ChartConstant;
...
public class AnalyzeService implements IAnalyzeService {
	...
	public JsonMsgUtil analyzeFddThAllAndComplete(String beginTime, String endTime, String type, Long projId,String jzType) {
		...
		List<HighchartCommon> highchartCommons = null;
		if (ChartConstant.CHART_DAY.equals(type)) {
			highchartCommons = analyzeDao.analyzeFddThAllAndCompleteByDay(beginTime, endTime, projId,jzType);
		}
		if (ChartConstant.CHART_MONTH.equals(type)) {
			highchartCommons = analyzeDao.analyzeFddThAllAndCompleteMonth(beginTime, endTime, projId,jzType);
		}
	...
	public JsonMsgUtil analyzeFddThAllAndCompleteByPerson(String beginTime, String endTime, Long projId,String jzType) {
		...
		List<HighchartCommon> highchartCommons = analyzeDao.analyzeFddThAllAndCompleteByPerson(beginTime, endTime,
				projId,jzType);
	...
	public JsonMsgUtil analyzeTddsfAllAndComplete(String beginTime, String endTime, String type, Long projId) {
		...
		List<HighchartCommon> highchartCommons = null;
		if (ChartConstant.CHART_DAY.equals(type)) {
			highchartCommons = analyzeDao.analyzeTddsfAllAndCompleteByDay(beginTime, endTime, projId);
		}
		if (ChartConstant.CHART_MONTH.equals(type)) {
			highchartCommons = analyzeDao.analyzeTddsfAllAndCompleteByMonth(beginTime, endTime, projId);
		}
	...
	public JsonMsgUtil analyzeTddsfAllAndCompleteByPerson(String beginTime, String endTime, Long projId) {
		...
		List<HighchartCommon> highchartCommons = analyzeDao.analyzeTddsfAllAndCompleteByPerson(beginTime, endTime,
				projId);
