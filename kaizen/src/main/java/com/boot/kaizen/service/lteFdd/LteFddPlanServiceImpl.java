...
public class LteFddPlanServiceImpl implements ILteFddPlanService {
	...
	@Override
	public void exportPlanDocHz(String absolutePath, LteFddPlanInfo lteFddPlanInfo, Map<String, String> map,
			HttpServletResponse response, HttpSession session) {
		try {
			HSSFWorkbook workbook = new HSSFWorkbook(new FileInputStream(new File(absolutePath)));
			...
			if (lteFddPlanInfo != null) {
				...
				for (int i = 0; i < 3; i++) {
					...
					row = sheetTwo.getRow(7 + j);
					cell = row.getCell(15);
					cell.setCellValue(map.get("csfbCallSuccAttempt" + i));
					cell = row.getCell(22);
					cell.setCellValue(map.get("csfbCallSuccSucc" + i));
					cell = row.getCell(28);
					...
					cell = row.getCell(22);
					cell.setCellValue(map.get("csfbPassiveCallSuccSucc" + i));
					cell = row.getCell(28);
